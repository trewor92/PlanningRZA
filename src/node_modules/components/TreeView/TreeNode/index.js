...
import {changeFolderCondition, fetchChildTreeData, fetchDataToTable} from 'actions'
...
class TreeNode extends Component
{
  ...
  getTableData = (node) =>
  {
    this.props.fetchDataToTable(node)
  }
  ...
  return (
    <React.Fragment>
      <StyledTreeNode level={level} type={(node.isFolder?"Folder":"File")}>
        ...
        <span role="button" onClick={()=>this.getTableData(node)}>
